...
object ClientLauncher {
    ...
    const val CLIENT_TITLE = "RSBox Client : v215.1"
    ...
    //const val RSA_MODULUS = ""
    val RSA_MODULUS = ClientLauncher::class.java.getResourceAsStream("/modulus.txt")?.readAllBytes()?.toString()
        ?: error("Server has not been setup. Run the 'setup server' gradle task first.")
