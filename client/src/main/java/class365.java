public final class class365 {
    ...
    static {
        for (int var0 = 0; var0 < field4334.length; ++var0) {
            field4334[var0] = (long) Math.pow(37.0, var0);
        }
    ...
    static void method6639(class102 var0) {
        int var3;
        int var4;
        int var5;
        int var7;
        if (var0.field975 != -1) {
            ...
            if (var2 != null) {
                ...
                if (var4 != 0 || var5 != 0) {
                    var7 = (int) (Math.atan2(var4, var5) * 325.94932345220167) & 2047;
                    var0.field1007 = var7;
                }
        ...
        if (0 == var0.field1010 || var0.field1014 > 0) {
            ...
            if (-1 != var0.field978 && -1 != var0.field979) {
                ...
                if (var5 != 0 || var6 != 0) {
                    var7 = (int) (Math.atan2(var5, var6) * 325.94932345220167) & 2047;
                    var8 = var7;
                }
