public class class154 {
    ...
    public Integer method2589(int var1) {
        if (this.field1396 == null) {
            ...
            class470 var3 = this.field1396.method8096(var1);
            return var3 != null && var3 instanceof class492 ? Integer.valueOf(((class492) var3).field4960) : null;
        }
    }
    ...
    boolean method2600(int var1, int var2) {
        if (null != this.field1396) {
            class470 var4 = this.field1396.method8096(var1);
            if (var4 != null) {
        ...
        this.field1396.method8097(new class492(var2), var1);
        return true;
    }
    ...
    boolean method2597(int var1, int var2, int var3, int var4) {
        ...
        var2 &= var8;
        if (null != this.field1396) {
            class470 var9 = this.field1396.method8096(var1);
            if (var9 != null) {
    ...
    boolean method2602(int var1, long var2) {
        ...
        this.field1396.method8097(new class490(var2), var1);
        return true;
    }
    ...
    boolean method2648(int var1, String var2) {
        ...
        this.field1396.method8097(new class486(var2), var1);
        return true;
    }
                ...
                if (var5 > 0) {
                    ...
                    while (var5-- > 0) {
                        ...
                        if (var8 == 0) {
                            ...
                            this.field1396.method8097(new class492(var9), var7);
                        } else if (var8 == 1) {
                            long var11 = var1.method8755();
                            this.field1396.method8097(new class490(var11), var7);
                        } else if (var8 == 2) {
                            String var12 = var1.method8873();
                            this.field1396.method8097(new class486(var12), var7);
                        }
                    }
                }
            }
