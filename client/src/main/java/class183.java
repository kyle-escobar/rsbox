public class class183 extends class476 {
    ...
    public class523 method3446() {
        if (this.field1890 < 0) {
            ...
            class523 var2 = (class523) field1900.method5643(this.field1890);
            if (null != var2) {
                return var2;
            } else {
                var2 = class485.method8408(field1888, this.field1890, 0);
                if (null != var2) {
                    field1900.method5640(var2, this.field1890);
                }
    ...
    public class523 method3441() {
        if (this.field1899 < 0) {
            ...
            class523 var2 = (class523) field1900.method5643(this.field1899);
            if (var2 != null) {
                return var2;
            } else {
                var2 = class485.method8408(field1888, this.field1899, 0);
                if (var2 != null) {
                    field1900.method5640(var2, this.field1899);
                }
