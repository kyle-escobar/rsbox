public class class93 extends class470 {
    ...
    static int method5753(int var0, int var1) {
        class93 var3 = (class93) field858.method8184(var0);
        if (var3 == null) {
            return -1;
        } else {
    ...
    static void method3491(int var0, int var1, int var2, int var3) {
        class93 var5 = (class93) field858.method8184(var0);
        if (var5 == null) {
            var5 = new class93();
            field858.method8193(var5, var0);
        }
    ...
    static void method1534(int var0) {
        class93 var2 = (class93) field858.method8184(var0);
        if (var2 != null) {
            var2.method8116();
        }
    }
