public class class184 extends class476 {
    ...
    void method3450(class519 var1, int var2) {
        int var4;
        int var5;
        if (var2 == 1) {
            ...
            if (var4 > 0) {
                if (this.field1913 != null && !field1921) {
                    var1.field5129 += var4 * 3;
                } else {
                    this.field1938 = new int[var4];
                    this.field1913 = new int[var4];

                    for (var5 = 0; var5 < var4; ++var5) {
                        this.field1913[var5] = var1.method8750();
                        this.field1938[var5] = var1.method8748();
                    }
                }
            }
        } else if (var2 == 2) {
            this.field1904 = var1.method8873();
        } else if (var2 == 5) {
            var4 = var1.method8748();
            if (var4 > 0) {
                if (null != this.field1913 && !field1921) {
                    var1.field5129 += var4 * 2;
                } else {
                    this.field1938 = null;
                    this.field1913 = new int[var4];
            ...
            this.field1940 = var1.method8748();
        } else if (var2 == 15) {
            this.field1944 = var1.method8748();
        } else if (var2 == 17) {
            this.field1922 = 0;
            ...
            this.field1924 = var1.method8748();
        } else if (var2 == 21) {
            this.field1925 = 0;
        } else if (var2 == 22) {
            this.field1926 = true;
            ...
            this.field1930 = var1.method8750();
            ...
            this.field1929 = var1.method8748();
        } else if (var2 == 29) {
            this.field1920 = var1.method8768();
        } else if (var2 == 39) {
            this.field1948 = var1.method8768() * 25;
        } else if (var2 >= 30 && var2 < 35) {
            this.field1932[var2 - 30] = var1.method8873();
            ...
            for (var5 = 0; var5 < var4; ++var5) {
                this.field1916[var5] = (short) var1.method8750();
                this.field1915[var5] = (short) var1.method8750();
            }
        } else if (var2 == 41) {
            var4 = var1.method8748();
            ...
            for (var5 = 0; var5 < var4; ++var5) {
                this.field1923[var5] = (short) var1.method8750();
                this.field1919[var5] = (short) var1.method8750();
            }
        } else if (var2 == 61) {
            var1.method8750();
        } else if (var2 == 62) {
            ...
            this.field1937 = var1.method8750();
        } else if (var2 == 66) {
            this.field1927 = var1.method8750();
        } else if (var2 == 67) {
            this.field1939 = var1.method8750();
        } else if (var2 == 68) {
            this.field1934 = var1.method8750();
        } else if (var2 == 69) {
            var1.method8748();
        } else if (var2 == 70) {
            this.field1928 = var1.method9001();
        } else if (var2 == 71) {
            this.field1941 = var1.method9001();
        } else if (var2 == 72) {
            this.field1942 = var1.method9001();
        } else if (var2 == 73) {
            this.field1943 = true;
        } else if (var2 == 74) {
            this.field1911 = true;
        } else if (var2 == 75) {
            this.field1945 = var1.method8748();
        } else if (var2 != 77 && var2 != 92) {
            if (var2 == 78) {
                this.field1949 = var1.method8750();
                this.field1950 = var1.method8748();
            } else if (var2 == 79) {
                this.field1931 = var1.method8750();
                this.field1952 = var1.method8750();
                this.field1950 = var1.method8748();
                var4 = var1.method8748();
                this.field1953 = new int[var4];

                for (var5 = 0; var5 < var4; ++var5) {
                    this.field1953[var5] = var1.method8750();
                }
            } else if (var2 == 81) {
                this.field1925 = var1.method8748() * 256;
            } else if (var2 == 82) {
                this.field1933 = var1.method8750();
            } else if (var2 == 89) {
            ...
            this.field1947 = var1.method8750();
            if (this.field1947 == 65535) {
                this.field1947 = -1;
            }

            this.field1917 = var1.method8750();
            ...
            var5 = var1.method8748();
            this.field1946 = new int[var5 + 2];

            for (int var6 = 0; var6 <= var5; ++var6) {
                this.field1946[var6] = var1.method8750();
    ...
    public final class228 method3465(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
        long var8;
        if (null == this.field1938) {
            var8 = var2 + ((long) this.field1912 << 10);
        } else {
            var8 = var2 + ((long) this.field1912 << 10) + ((long) var1 << 3);
        }

        Object var10 = field1909.method5643(var8);
        if (null == var10) {
    ...
    public final class249 method3449(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
        ...
        if (this.field1938 == null) {
            ...
            var8 = var2 + ((long) var1 << 3) + ((long) this.field1912 << 10);
        }
    ...
    public final class249 method3454(int var1, int var2, int[][] var3, int var4, int var5, int var6, class215 var7, int var8) {
        long var10;
        if (this.field1938 == null) {
            var10 = var2 + ((long) this.field1912 << 10);
        } else {
            var10 = var2 + ((long) this.field1912 << 10) + ((long) var1 << 3);
        }
    ...
    final class213 method3455(int var1, int var2) {
        ...
        if (this.field1938 == null) {
            ...
            for (int var7 = 0; var7 < var6; ++var7) {
                ...
                var4 = (class213) field1914.method5643(var8);
                if (var4 == null) {
                    ...
                    field1914.method5640(var4, var8);
                }
            ...
            var4 = (class213) field1914.method5643(var6);
            if (var4 == null) {
                ...
                field1914.method5640(var4, var6);
            }
        }

        var5 = 128 != this.field1937 || 128 != this.field1927 || this.field1939 != 128;

        boolean var11;
        var11 = this.field1928 != 0 || this.field1941 != 0 || this.field1942 != 0;
