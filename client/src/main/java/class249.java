...
public class class249 extends class228 {
    ...
    public void method4763() {
        if (this.field2759 != 1) {
            ...
            this.field2752 = (int) (Math.sqrt(this.field2752) + 0.99);
            this.field2754 = (int) (Math.sqrt(this.field2752 * this.field2752 + super.field2507 * super.field2507) + 0.99);
            this.field2753 = this.field2754 + (int) (Math.sqrt(this.field2752 * this.field2752 + this.field2751 * this.field2751) + 0.99);
        }
    }
                ...
                if (this.field2735[var7] != -2) {
                    ...
                    if (var1 && (var11 == -5000 || var12 == -5000 || var13 == -5000)) {
                        ...
                        if ((var11 - var12) * (field2747[var10] - field2747[var9]) - (field2747[var8] - field2747[var9]) * (var13 - var12) > 0) {
                            ...
                            field2780[var7] = var11 < 0 || var12 < 0 || var13 < 0 || var11 > var32 || var12 > var32 || var13 > var32;
