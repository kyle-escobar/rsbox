...
public final class class455 {
    ...
    float[] method7946() {
        ...
        if ((double) this.field4749[2] < 0.999 && (double) this.field4749[2] > -0.999) {
            var2[1] = (float) (-Math.asin(this.field4749[2]));
            ...
            var2[0] = 0.0F;
            var2[1] = (float) Math.atan2(this.field4749[2], 0.0);
            var2[2] = (float) Math.atan2(-this.field4749[9], this.field4749[5]);
        }
    ...
    public float[] method7956() {
        float[] var2 = new float[]{(float) (-Math.asin(this.field4749[6])), 0.0F, 0.0F};
        double var3 = Math.cos(var2[0]);
        double var5;
        double var7;
        if (Math.abs(var3) > 0.005) {
            var5 = this.field4749[2];
            var7 = this.field4749[10];
            double var9 = this.field4749[4];
            double var11 = this.field4749[5];
            var2[1] = (float) Math.atan2(var5, var7);
            var2[2] = (float) Math.atan2(var9, var11);
        } else {
            var5 = this.field4749[1];
            var7 = this.field4749[0];
