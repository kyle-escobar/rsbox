...
public class class215 extends class476 {
    ...
    public static class215 method2582(int var0) {
        class215 var2 = (class215) field2335.method5643(var0);
        if (null != var2) {
            return var2;
        } else {
            ...
            var2 = new class215();
            if (var3 != null) {
                var2.method4048(new class519(var3));
            }

            var2.method4051();
            field2335.method5640(var2, var0);
            return var2;
        }
    }

    static class247 method3309(int var0) {
        class247 var2 = (class247) field2354.method5643(var0);
        if (null != var2) {
            return var2;
        } else {
            var2 = class247.method2455(class323.field3536, class176.field1856, var0, false);
            if (null != var2) {
                field2354.method5640(var2, var0);
            }
    ...
    public static int method5358(int var0) {
        class156 var3 = (class156) field2342.method5643(var0);
        class156 var2;
        if (null != var3) {
            var2 = var3;
        } else {
            ...
            if (null != var4) {
                field2342.method5640(var4, var0);
            }
    ...
    void method4050(class519 var1, int var2) {
        int var4;
        int var5;
        if (var2 == 1) {
            ...
            for (var5 = 0; var5 < var4; ++var5) {
                this.field2344[var5] = var1.method8750();
            }

            this.field2336 = new int[var4];

            for (var5 = 0; var5 < var4; ++var5) {
                this.field2336[var5] = var1.method8750();
            }

            for (var5 = 0; var5 < var4; ++var5) {
                this.field2336[var5] += var1.method8750() << 16;
            }
        } else if (var2 == 2) {
            this.field2355 = var1.method8750();
        } else if (var2 == 3) {
            var4 = var1.method8748();
            this.field2347 = new int[var4 + 1];

            for (var5 = 0; var5 < var4; ++var5) {
                this.field2347[var5] = var1.method8748();
            }
            ...
            this.field2330 = var1.method8748();
        } else if (var2 == 6) {
            this.field2345 = var1.method8750();
        } else if (var2 == 7) {
            this.field2352 = var1.method8750();
        } else if (var2 == 8) {
            this.field2353 = var1.method8748();
            this.field2357 = true;
        } else if (var2 == 9) {
            this.field2351 = var1.method8748();
        } else if (var2 == 10) {
            this.field2356 = var1.method8748();
        } else if (var2 == 11) {
            this.field2346 = var1.method8748();
        } else if (var2 == 12) {
            var4 = var1.method8748();
            this.field2343 = new int[var4];

            for (var5 = 0; var5 < var4; ++var5) {
                this.field2343[var5] = var1.method8750();
            }

            for (var5 = 0; var5 < var4; ++var5) {
                this.field2343[var5] += var1.method8750() << 16;
            }
        } else if (var2 == 13) {
            var4 = var1.method8748();
            ...
            for (var5 = 0; var5 < var4; ++var5) {
                this.field2337[var5] = var1.method8752();
            }
        } else if (var2 == 14) {
            this.field2338 = var1.method9000();
        } else if (var2 == 15) {
            var4 = var1.method8750();
            ...
            for (var5 = 0; var5 < var4; ++var5) {
                ...
                int var7 = var1.method8752();
                this.field2339.put(var6, var7);
            }
        } else if (var2 == 16) {
            this.field2340 = var1.method8750();
            this.field2341 = var1.method8750();
        } else if (var2 == 17) {
            ...
            for (var5 = 0; var5 < var4; ++var5) {
                this.field2348[var1.method8748()] = true;
            }
        }
