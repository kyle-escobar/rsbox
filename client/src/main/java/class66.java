public class class66 {
   ...
   int method1394(int var1, float var2) {
      ...
      if (var1 == 0) {
         ...
         var3 *= 0.0030517578F;
         field519 = (float)Math.pow(0.1, (double)(var3 / 20.0F));
      ...
      if (this.field516[var1] == 0) {
         ...
         field515[var1][0] = var3 * -2.0F * (float)Math.cos((double)this.method1393(var1, 0, var2));
         ...
         for(var4 = 1; var4 < this.field516[var1]; ++var4) {
            ...
            float var5 = var3 * -2.0F * (float)Math.cos((double)this.method1393(var1, var4, var2));
