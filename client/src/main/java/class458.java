public class class458 {
    ...
    class458(float[] var1, int var2) {
        this.field4752 = var1;
        this.field4753 = var2;
    }

    public static int method8711(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
        float var8 = 0.0F;
        ...
        float var42 = (Math.abs(var2) + Math.abs(var4)) * (float) (var1 + 1) * class130.field1222;
        if (var8 <= var42) {
            return -1;
        } else {
            ...
            if (var1 == 0) {
                ...
                boolean var44 = var5 ? var4 > var6[0] - var42 : var4 > var42 + var6[0];
                ...
                class458 var12 = new class458(var10, var1);
                ...
                int var15 = method8711(var13, var1 - 1, var2, false, var4, false, var45);
                if (var15 == -1) {
                    return 0;
                } else {
                    boolean var16 = false;
                    ...
                    for (int var21 = 0; var21 <= var15; ++var21) {
                        ...
                        if (var21 == 0) {
                            var17 = var2;
                            var19 = method6369(var10, var1, var2);
                        ...
                        var18 = method6369(var10, var1, var20);
                        if (var16) {
                            var16 = false;
                            ...
                            float var25 = var17;
                            float var26 = var20;
                            float var27 = method6369(var12.field4752, var12.field4753, var17);
                            float var24;
                            if (Math.abs(var27) < class130.field1222) {
                                var24 = var17;
                            } else {
                                float var28 = method6369(var12.field4752, var12.field4753, var20);
                                if (Math.abs(var28) < class130.field1222) {
                                    var24 = var20;
                                } else {
                                    float var29 = 0.0F;
                                    float var30 = 0.0F;
                                    ...
                                    do {
                                        ...
                                        float var39 = class130.field1224 * Math.abs(var26) + 0.0F;
                                        ...
                                        if (var41) {
                                            if (!(Math.abs(var31) < var39) && !(Math.abs(var27) <= Math.abs(var28))) {
                                                ...
                                                if (var25 == var29) {
                                                    ...
                                                    var32 = ((var33 - var34) * var40 * 2.0F * var33 - (var26 - var25) * (var34 - 1.0F)) * var35;
                                                ...
                                                var35 = var31;
                                                var31 = var30;
                                                if (var32 * 2.0F < var33 * var40 * 3.0F - Math.abs(var33 * var39) && var32 < Math.abs(var33 * var35 * 0.5F)) {
                                                    var30 = var32 / var33;
                                                } else {
                                                    var30 = var40;
                                                    var31 = var40;
                                            ...
                                            var28 = method6369(var12.field4752, var12.field4753, var26);
    ...
    static float method6369(float[] var0, int var1, float var2) {
