public final class class84 extends class102 {
    boolean field744;
    boolean field756;
    boolean field760;
    class249 field751;
    ...
    void method1784(class519 var1) {
        var1.field5129 = 0;
        int var3 = var1.method8748();
        boolean var4 = true;
        this.field739 = var1.method8768();
        this.field752 = var1.method8768();
        int var5 = -1;
        this.field757 = 0;
        int[] var6 = new int[12];
        ...
        super.field989 = var1.method8750();
        if (super.field989 == 65535) {
            super.field989 = -1;
        }

        super.field995 = var1.method8750();
        if (65535 == super.field995) {
            super.field995 = -1;
        }

        super.field948 = super.field995;
        super.field993 = var1.method8750();
        if (65535 == super.field993) {
            super.field993 = -1;
        }

        super.field1004 = var1.method8750();
        if (super.field1004 == 65535) {
            super.field1004 = -1;
        }

        super.field1001 = var1.method8750();
        if (super.field1001 == 65535) {
            super.field1001 = -1;
        }

        super.field984 = var1.method8750();
        if (65535 == super.field984) {
            super.field984 = -1;
        }

        super.field953 = var1.method8750();
        if (65535 == super.field953) {
            super.field953 = -1;
        }

        this.field740 = new class526(var1.method8873(), class454.field4743);
        this.method1812();
        this.method1785();
        this.method1805();
        ...
        this.field743 = var1.method8748();
        this.field761 = var1.method8750();
        this.field760 = var1.method8748() == 1;
        ...
        for (var12 = 0; var12 < 3; ++var12) {
            this.field742[var12] = var1.method8873();
        }

        int var27 = var1.method8748();
    ...
    void method1786(int var1, int var2, class223 var3) {
        ...
        if (var1 >= 0 && var1 < 104 && var2 >= 0 && var2 < 104) {
            if (super.field945[0] >= 0 && super.field945[0] < 104 && super.field1012[0] >= 0 && super.field1012[0] < 104) {
    ...
    void method1795(int var1, int var2) {
        ...
        super.field949 = super.field945[0] * 128 + var4 * 64;
        super.field963 = super.field1012[0] * 128 + var4 * 64;
    }

    void method1792(int var1, int var2, class223 var3) {
        if (super.field1010 < 9) {
            ++super.field1010;
        }

        for (int var5 = super.field1010; var5 > 0; --var5) {
            super.field945[var5] = super.field945[var5 - 1];
            super.field1012[var5] = super.field1012[var5 - 1];
