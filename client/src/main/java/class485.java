...
public class class485 {
    ...
    public void method8207(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
        if (this.field4898.method8415()) {
            ...
            this.method8211();
            if (var3) {
                int var9 = (int) Math.ceil((float) var6 / this.field4903);
                int var10 = (int) Math.ceil((float) var7 / this.field4903);
    ...
    public void method8398(int var1, int var2, int var3, int var4, int var5) {
        ...
        if (var8 < 100) {
            ...
            int var9 = (int) Math.ceil((float) var3 / this.field4903);
            int var10 = (int) Math.ceil((float) var4 / this.field4903);
    ...
    public void method8259(int var1, int var2, int var3, int var4, int var5, int var6) {
        if (this.field4898.method8415()) {
            int var8 = (int) Math.ceil((float) var3 / this.field4903);
            int var9 = (int) Math.ceil((float) var4 / this.field4903);
