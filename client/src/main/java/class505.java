public class class505 extends class476 {
   ...
   public static class505 method7608(int var0) {
      class505 var2 = (class505)field5065.method5643((long)var0);
      if (var2 != null) {
         return var2;
      } else {
         ...
         var2 = new class505();
         if (var3 != null) {
            var2.method8572(new Buffer(var3));
         }

         var2.method8571();
         field5065.method5640(var2, (long)var0);
         return var2;
      }
   }
   ...
   void method8573(Buffer var1, int var2) {
      if (var2 == 1) {
