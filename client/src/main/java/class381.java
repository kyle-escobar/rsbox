...
public class class381 {
    ...
    public class381() {
        ...
        for (var3 = 12; var1 < 16; var2 -= var3) {
            var4 = class278.method6634((float) var2 / 360.0F, 0.9998999834060669, (float) var1 * 0.425F / 16.0F + 0.075F);
        ...
        for (var3 = var2 / 6; var1 < class235.field2616.length; var2 -= var3) {
            ...
            for (int var5 = class278.method6634((float) var2 / 360.0F, 0.9998999834060669, 0.5); var1 < var4 && var1 < class235.field2616.length; ++var1) {
    ...
    void method6820(int var1) {
        int var3 = var1 * 2 + 1;
        double var5 = (float) var1 / 3.0F;
        int var7 = 1 + var1 * 2;
        double[] var8 = new double[var7];
        int var9 = -var1;

        for (int var10 = 0; var9 <= var1; ++var10) {
            var8[var10] = class444.method10(var9, 0.0, var5);
            ++var9;
        }
