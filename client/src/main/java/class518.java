...
public class class518 extends class476 {
    ...
    public class518(class342 var1, int var2, int var3) {
        ...
        this.method8723(new class519(var4));
    }

    public class518(class342 var1, int var2) {
        byte[] var3 = var1.method6381(var2, 0);
        this.method8723(new class519(var3));
    }

    void method8723(class519 var1) {
        int var3 = var1.method8993();
        this.field5124 = new class507[var3];
        this.field5122 = new ArrayList(var3);

        for (int var4 = 0; var4 < var3; ++var4) {
            this.field5124[var4] = (class507) class373.method1724(class507.method8599(), var1.method8748());
            int var5 = var1.method8993();
            HashMap var6 = new HashMap(var5);

            while (var5-- > 0) {
                Object var7 = this.field5124[var4].method8596(var1);
                int var8 = var1.method8993();
                ArrayList var9 = new ArrayList();

                while (var8-- > 0) {
                    int var10 = var1.method8993();
                    var9.add(var10);
                }
