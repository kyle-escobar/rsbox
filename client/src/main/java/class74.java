public final class class74 extends class228 {
   ...
   final void method1518(int var1, int var2, int var3, int var4) {
      double var6;
      if (!this.field604) {
         var6 = (double)(var1 - this.field595);
         double var8 = (double)(var2 - this.field596);
         ...
         this.field615 = (double)this.field593;
      }

      var6 = (double)(1 + this.field600 - var4);
   ...
   final void method1519(int var1) {
      this.field604 = true;
