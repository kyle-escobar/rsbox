public class class205 extends class476 {
   ...
   public static class205 method3634(int var0) {
      class205 var2 = (class205)field2205.method5643((long)var0);
      if (null != var2) {
         return var2;
      } else {
      ...
      if (var2 == 1) {
         ...
         if (var2 == 40) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.field2210[var5] = (short)var1.readUnsignedShort();
               this.field2211[var5] = (short)var1.readUnsignedShort();
            }
         } else if (var2 == 41) {
            var4 = var1.readUnsignedByte();
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.field2215[var5] = (short)var1.readUnsignedShort();
               this.field2213[var5] = (short)var1.readUnsignedShort();
            }
         }
      }
   ...
   public final class249 method3858() {
      class249 var2 = (class249)field2207.method5643((long)this.field2218);
      if (null == var2) {
         ...
         field2207.method5640(var2, (long)this.field2218);
      }
