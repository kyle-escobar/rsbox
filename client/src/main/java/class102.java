public abstract class class102 extends class228 {
   ...
   final void method2067(int var1, int var2, int var3, int var4, int var5, int var6) {
      class183 var9 = (class183)class183.field1889.method5643((long)var1);
      class183 var8;
      if (null != var9) {
         var8 = var9;
      } else {
   ...
   final void method2068(int var1) {
      class183 var4 = (class183)class183.field1889.method5643((long)var1);
      class183 var3;
      if (null != var4) {
         var3 = var4;
      } else {
   ...
   void method2080(int var1, int var2, int var3, int var4) {
      ...
      class521 var7 = (class521)this.field944.method8096((long)var1);
      if (var7 != null) {
         var7.method8116();
         --this.field991;
      }
      ...
      if (var2 != 65535 && var2 != -1) {
         ...
         this.field944.method8097(new class521(var2, var3, var6, var8), (long)var1);
         ++this.field991;
      }
   }
