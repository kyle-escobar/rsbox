...
public abstract class class424 {
    ...
    public static class424 method5688(Socket var0, int var1, int var2) throws IOException {
    ...
    public abstract int method7585() throws IOException;

    public abstract int method7602() throws IOException;

    public abstract int method7603(byte[] var1, int var2, int var3) throws IOException;

    public abstract void method7589();

    public abstract void method7588(byte[] var1, int var2, int var3) throws IOException;
}
