...
public class PacketBuffer extends class470 {
   ...
   public PacketBuffer(int var1, boolean var2) {
      this.data = class401.method7062(var1, var2);
   }

   public PacketBuffer(byte[] var1) {
      this.data = var1;
      this.offset = 0;
   }
   ...
   public void writeBytes(PacketBuffer var1) {
