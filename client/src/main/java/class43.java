...
public abstract class class43 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    protected void method798(String var1) {
        this.field294.setContents(new StringSelection(var1), null);
    }
    ...
    protected final void method684(int var1, String var2, boolean var3) {
        try {
            ...
            try {
                ...
                var5.drawImage(class468.field4804, class343.field3838 / 2 - 152, class488.field4948 / 2 - 18, null);
            } catch (Exception var10) {
    ...
    Container method688() {
        return null != this.field278 ? this.field278 : this;
    }
