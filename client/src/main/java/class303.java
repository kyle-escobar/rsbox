...
public class class303 {
    ...
    public static void method2298(ArrayList var0, int var1, int var2, int var3, int var4, boolean var5) {
        ...
        if (!var0.isEmpty()) {
            ...
            if (!field3196.isEmpty()) {
                ...
                field3199.add(new class395(null));
                field3199.add(new class409(null, field3193, field3197, field3201));
                if (!field3194.isEmpty()) {
                    ArrayList var7 = new ArrayList();
                    var7.add(new class404(new class399(new class392(null, 0, true, field3207)), field3203));
                    ArrayList var8 = method3308();
                    var7.add(new class404(new class414(new class411(null, var8), 0, false, field3202), field3192));
                    field3199.add(new class396(null, var7));
                } else {
                    field3199.add(new class404(null, field3203));
                    field3199.add(new class399(null));
                    field3199.add(new class392(null, 0, true, field3207));
                }
    ...
    public static void method4211(int var0, int var1) {
        ...
        if (!field3194.isEmpty() && (var0 != 0 || var1 != 0)) {
            field3199.add(new class404(null, field3192));
            field3199.add(new class414(null, 0, false, field3202));
        }

        ArrayList var3 = method3308();
        field3199.add(new class411(null, var3));
    }
    ...
    public static boolean method1987() {
        if (!field3199.isEmpty()) {
            ...
            return !field3194.isEmpty() && field3194.get(0) != null && ((class322) field3194.get(0)).field3533 != null && ((class322) field3194.get(0)).field3533.method5533();
        }
    }
    ...
    public static void method8062(int var0, int var1, int var2, int var3) {
        if (field3194.size() > 1 && field3194.get(0) != null && ((class322) field3194.get(0)).field3533.method5533() && field3194.get(1) != null && ((class322) field3194.get(1)).field3533.method5533()) {
            ...
            field3199.add(new class400(null));
            ArrayList var5 = new ArrayList();
            var5.add(new class404(new class392(null, 1, false, field3207), field3203));
            var5.add(new class404(new class414(null, 0, false, field3202), field3192));
            field3199.add(new class396(null, var5));
